                    ...
                    <div class="card-body">
                        <form id="CreditAmountAddingFrom" method="POST" action="booking_confirmC.php">
                            ...
                            <div class="form-group">
                                <label for="riderPhone">Rider Phone Number</label>
                                <input type="text" class="form-control" id="riderPhone" name="riderPhone">
                                <div id="suggestions" class="suggestions-list"></div>
                            </div>

                            <input type="text" class="form-control" id="rideBookId" value="<?php echo $route['id']; ?>" name="rideBookID" hidden>
                            <input type="text" class="form-control" value="<?php echo $route['id']; ?>" name="rideBookID" hidden>
                            <div class="form-group">
                            ...
                            <button id=" bKash_button" class="btn btn-primary">Make Confirm Booking</button>
