                ...
                <?php foreach ($results as $row) { ?>
                    <tr>
                        ...
                        <td><span class="badge badge-pill 
                            <?php if($row['status'] == 2){ echo "badge-success"; }else if($row['status'] ==1) { echo "badge-info"; }else if($row['status'] ==3) { echo "badge-danger"; }else if($row['status'] ==0) { echo "badge-primary"; } ?>
                        ">
